...
const _UseravatarTypeEnumValueMap = {
  r'asset': r'asset',
  r'url': r'url',
  r'file': r'file',
  r'none': r'none',
...
const _UsertypeEnumValueMap = {
  r'you': r'you',
  r'friend': r'friend',
  r'blacklist': r'blacklist',
};
const _UsertypeValueEnumMap = {
  r'you': UserType.you,
  r'friend': UserType.friend,
  r'blacklist': UserType.blacklist,
};
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  QueryBuilder<User, User, QAfterFilterCondition> avatarIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'avatarType',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> avatarTypeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'avatarType',
        value: '',
  ...
  QueryBuilder<User, User, QAfterFilterCondition> createAtEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'createAt',
        value: value,
...
extension UserQuerySortBy on QueryBuilder<User, User, QSortBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> sortByAvatarType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarType', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> sortByAvatarTypeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserQuerySortThenBy on QueryBuilder<User, User, QSortThenBy> {
  ...
  QueryBuilder<User, User, QAfterSortBy> thenByAvatarType() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarType', Sort.asc);
    });
  }

  QueryBuilder<User, User, QAfterSortBy> thenByAvatarTypeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'avatarType', Sort.desc);
    });
  }
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByAvatarType(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
